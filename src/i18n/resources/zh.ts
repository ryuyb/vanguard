...
export const zhTranslationCatalog: AppTranslationCatalog = {
  ...
  send: {
    ...
    list: {
      ...
      noExpiration: "无过期时间",
      expiresOn: "过期于 {{date}}",
      viewCount: "{{count}}/{{max}} 次查看",
      empty: {
        title: "暂无 Send",
        description: "创建 Send 安全分享文本或文件",
        action: "创建 Send",
      },
    },
    form: {
      createTitle: "创建 Send",
      editTitle: "编辑 Send",
      createDescription: "创建新的 Send 安全分享内容",
      editDescription: "编辑 Send 详情",
      type: "类型",
      name: "名称",
      textContent: "文本内容",
      hideText: "默认隐藏文本",
    ...
    feedback: {
      createSuccess: "Send 已创建",
      createError: "创建 Send 失败",
      saveSuccess: "Send 已保存",
