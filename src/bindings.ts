...
export type VaultCipherItemDto = { id: string; folderId: string | null; organizationId: string | null; type: number | null; name: string | null; username: string | null; favorite: boolean | null; creationDate: string | null; revisionDate: string | null; deletedDate: string | null; attachmentCount: number }
