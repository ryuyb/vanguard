...
import { PasswordSetupForm } from "@/features/auth/register/components/password-setup-form";
...
export function RegisterPage({
  ...
  const {
    ...
    onRegistrationComplete: navigateToVault,
  });
        ...
        <section className="relative mx-auto w-full max-w-md">
          <Card className="border-slate-200/60 bg-white shadow-2xl shadow-slate-900/5">
            <CardHeader className="space-y-4 pb-6">
              ...
              <div className="space-y-1 text-center">
                <CardTitle className="text-2xl font-semibold tracking-tight text-slate-900">
                  {t("auth.register.passwordSetup.title")}
                </CardTitle>
                <p className="text-sm text-slate-600">
                  {t("auth.register.passwordSetup.subtitle", {
                    email: feedback.email,
                  })}
                </p>
              </div>
            ...
            <CardContent className="pb-8">
              {isFinishingRegistration && submitProgressText && (
              ...
              <PasswordSetupForm
                ...
                isSubmitting={isFinishingRegistration}
              />
            </CardContent>
          </Card>
        </section>
