...
pub fn run() {
    let specta_builder = tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            interfaces::tauri::commands::config::config_check_text_injection_permission,
            ...
            interfaces::tauri::commands::vault::has_local_unlock_data,
            ...
            interfaces::tauri::commands::cipher::vault_execute_autofill,
            interfaces::tauri::commands::cipher::vault_get_cipher_totp_code,
            interfaces::tauri::commands::icon::get_icon,
            interfaces::tauri::commands::icon::clear_icon_cache,
